...
meta <- read.csv("R46d_Meta.csv", header=T)
gesundheit <- read.csv("R46d_Gesundheit.csv", header=T, na.strings = c(-1111.1, -2222, -2222.2))
...
# t4_start
boxplot(gesundheit$Prim_Care_Phys_Rate~gesundheit$HPSA_Ind)
